...
export default function ProfilesPage() {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {addModalOpen && (
        <AppDialog title="Add Family Member" onClose={() => setAddModalOpen(false)} className="w-full max-w-lg bg-white dark:bg-[#1E293B] rounded-3xl p-4 sm:p-8 shadow-2xl border border-slate-200 dark:border-slate-700 space-y-5 overflow-y-auto">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              ...
              <button onClick={() => setAddModalOpen(false)} aria-label="Close dialog" className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center text-slate-400 hover:text-slate-600">
                <X className="w-5 h-5" />
              </button>
            </div>
