    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-16">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="text-4xl sm:text-5xl font-serif font-bold text-brand-navy dark:text-white leading-tight">
          From first stars to lasting legacy.
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="p-8 rounded-3xl bg-white dark:bg-[#1E293B] border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
      ...
      {/* CTA Box */}
      <div className="p-8 sm:p-12 rounded-3xl bg-brand-navy text-white text-center space-y-4">
        <h2 className="text-2xl sm:text-3xl font-serif font-bold">Start your family's money journey today.</h2>
