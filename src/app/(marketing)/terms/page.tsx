    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 pb-16 space-y-12">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none text-sm leading-relaxed space-y-8">
        <section className="space-y-3">
          <h2 className="text-xl font-serif font-bold text-brand-navy dark:text-white text-center">1. Acceptance of Terms</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-serif font-bold text-brand-navy dark:text-white text-center">2. Not a Bank / Financial Advice Disclaimer</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-serif font-bold text-brand-navy dark:text-white text-center">3. User Responsibilities & Account Security</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-serif font-bold text-brand-navy dark:text-white text-center">4. Parental Supervision of Child Profiles</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-serif font-bold text-brand-navy dark:text-white text-center">5. Termination</h2>
          <p>
