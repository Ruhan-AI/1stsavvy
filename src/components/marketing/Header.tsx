...
export function MarketingHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#F9F7F8]/95 dark:bg-[#1A232E]/95 border-b border-slate-200/80 dark:border-slate-800/80 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="lg:hidden inline-flex items-center justify-center min-h-[44px] min-w-[44px] -mr-2 rounded-lg text-brand-navy dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
