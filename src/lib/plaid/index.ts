...
export const PLAID_SANDBOX_INSTITUTIONS: PlaidInstitution[] = [
  {
    id: 'ins_109508',
    name: 'Premier National Bank (Sandbox)',
    logo: 'Landmark',
    color: '#3B82F6',
  ...
  {
    id: 'ins_109510',
    name: 'Pacific Horizon Bank (Sandbox)',
    logo: 'Landmark',
    color: '#D97706',
    products: ['auth', 'transactions'],
  },
  {
    id: 'ins_109511',
    name: 'Horizon Index Investments (Sandbox)',
    logo: 'TrendingUp',
    color: '#0D9488',
  ...
  {
    id: 'ins_109512',
    name: 'Apex Retirement Trust (Sandbox)',
    logo: 'ShieldCheck',
    color: '#16A34A',
    products: ['investments', 'holdings'],
  },
